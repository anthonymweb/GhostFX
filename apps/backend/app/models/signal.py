...
class Signal(UUIDMixin, TimestampMixin, Base):
    ...
    reasoning: Mapped[list[str]] = mapped_column(JsonDict, default=list)
    indicators: Mapped[dict] = mapped_column(JsonDict, default=dict)
    market_context: Mapped[dict] = mapped_column(JsonDict, default=dict)
